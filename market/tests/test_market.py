...
def role_feriante(db):
    role, _ = Role.objects.get_or_create(
        name='Feriante',
        defaults={'description': 'Vendedor de feria'}
    )
    return role
...
@pytest.mark.django_db
def test_otro_feriante_no_crea_producto_exitosamente_en_puesto_ajeno(api_client, puesto, otro_feriante):
    """
