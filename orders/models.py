...
class Payment(models.Model):
    ...
    def __str__(self):
        return f"Payment {self.id} - {self.provider} - {self.provider_ref} - {self.status}"
...
class PaymentLog(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['provider', 'provider_ref'], name='uq_paymentlog_provider_ref')
        ]
